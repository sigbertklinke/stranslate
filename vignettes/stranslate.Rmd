...
ATTENTION: All comparison are __character__ comparisons. In doubt, make sure that you convert your parameters yourself, e.g. `getMsg(ROUND=as.character(3))`. 
